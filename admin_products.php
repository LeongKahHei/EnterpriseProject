      ...
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td><?= $fetch_products['category']; ?></td>
             <td class="image"><?= $fetch_products['details']; ?></td>
             <td><?= $fetch_products['price']; ?></td>
            <td>
               <a href="admin_update_product.php?update=<?= $fetch_products['id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
      </table>
   </div>
